    ...
    <div class="row">
		<div class="col-md-6">
			<div class="card">
                ...
                <div class="card-body">
				<form method="post" action="lappelanggaran/aksi_lappelanggaran.php" target=_blank>
                        ...
                        <div class="col col-md-3"><label for="select" class=" form-control-label">Jenis Pelanggaran</label></div>
                            <div class="col-12 col-md-9">
                                <select name="cmbjenis" class="form-control">
									<?php
										$jenis=mysqli_query($con,"Select * from tbjenispelanggaran");
										while($j=mysqli_fetch_array($jenis)){
											echo"<option value='$j[id_jenispelanggaran]'>$j[nama_jenispelanggaran]</option>";
										}
									?>
                                </select>
                        </div>
		...
		<div class="col-lg-6">
            <div class="card">
                ...
                <div class="card-body card-block">
					<form action="lappelanggaran/aksi_lappelanggaran.php" method="post" class="form-horizontal" target=_blank>
						<div class="row form-group">
